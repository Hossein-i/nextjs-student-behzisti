 ...
 */
export const Subheadline: React.ForwardRefExoticComponent<
  SubheadlineProps & React.RefAttributes<SubheadlineProps>
> = forwardRef(({ level = '1', className, Component, ...restProps }, ref) => (
  <Typography
    {...restProps}
    ref={ref}
